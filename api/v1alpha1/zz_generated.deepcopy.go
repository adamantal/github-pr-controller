...
func (in *PullRequestStatus) DeepCopyInto(out *PullRequestStatus) {
	*out = *in
	...
	if in.Workflows != nil {
		...
		*out = make([]WorkflowRunStatus, len(*in))
		copy(*out, *in)
	}
}
...
func (in *RepositorySpec) DeepCopyInto(out *RepositorySpec) {
	*out = *in
	in.SyncPullRequests.DeepCopyInto(&out.SyncPullRequests)
	if in.WorkflowFileNames != nil {
		in, out := &in.WorkflowFileNames, &out.WorkflowFileNames
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}
